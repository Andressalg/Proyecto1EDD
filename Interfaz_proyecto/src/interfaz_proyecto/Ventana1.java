...
public class Ventana1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(440, 310));

        continuar_btn.setBackground(new java.awt.Color(153, 204, 255));
        continuar_btn.setForeground(new java.awt.Color(255, 255, 255));
        continuar_btn.setText("Continuar");
        continuar_btn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel1.setFont(new java.awt.Font("Roboto Medium", 2, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("PROYECTO 1");

        jLabel3.setFont(new java.awt.Font("Roboto Medium", 2, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Hecho por: Andrés Salgueiro, Salomé García, tercer integrante");
